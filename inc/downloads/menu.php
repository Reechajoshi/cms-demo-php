...
<?php
	echo("
		...
		tabs.addCallBackURLTab(menuid + 'dwnall', { name: 'Downloads', cbURL: '$me?b=dwnall', cbProcessInputCodes: false, txtColor: '#28A9D3', txtSelectColor: '#28A9D3', tabLImage: 'images/tabs/tabl.png', tabTImage: 'images/tabs/tabt.png', tabRImage: 'images/tabs/tabr.png', extraBackdrop: '#28A9D3', borderSelect: '#fff 1px solid', userTabControl: false } );
