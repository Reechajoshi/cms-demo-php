...
<script type="text/javascript"> <!--
	...
	tabprops['TAB_PRODUCTS'] = { txtColor: '#28A9D3', txtSelectColor: '#28A9D3', tabLImage: 'images/tabs/tabl.png', tabTImage: 'images/tabs/tabt.png', tabRImage: 'images/tabs/tabr.png', extraBackdrop: '#28A9D3', borderSelect: '#fff 1px solid' };
	...
	var addDynTabMain = function(parentTabID,newTabID,newTabIDFix,tabTxt,iuri,isNMailer,makeDirectReq)
	{
		...
		if(!tabc)
		{
			var p = false;
			if( makeDirectReq )
				p = { name: tabTxt, txtColor: "#fff", iframeURL: iuri };
			else
				p = { name: tabTxt, txtColor: "#fff", cbURL: iuri };
